...
5. [Machine Learning Models](#5-machine-learning-models)
   ...
   - 5.2 SVC (Baseline Comparator)
   - 5.3 Random Forest (Baseline Comparator)
...
### 5.2 SVC (Support Vector Classifier) — Baseline Comparator
...
### 5.3 Random Forest Classifier — Baseline Comparator
